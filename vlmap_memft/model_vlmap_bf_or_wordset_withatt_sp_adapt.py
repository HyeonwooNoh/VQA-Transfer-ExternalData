...
class Model(object):
    ...
    def build_object_V_ft(self):
        ...
        flat_pooled_V_ft = modules.attention_pooling(v_adapt, att_score)  # [bs * #obj, vfeat_dim]
        pooled_V_ft = tf.reshape(
            flat_pooled_V_ft, [-1, self.data_cfg.n_obj_bf, V_DIM])
    ...
    def build_attribute_V_ft(self):
        ...
        flat_pooled_V_ft = modules.attention_pooling(v_adapt, att_score)  # [bs * #obj, vfeat_dim]
        pooled_V_ft = tf.reshape(
            flat_pooled_V_ft, [-1, self.data_cfg.n_attr_bf, V_DIM])
