...
word2contexts_path = os.path.join(
    config.bookcorpus_dir, 'word2contexts_w{}.pkl'.format(config.context_window_size))
...
save_name = 'bookcorpus_context_dict_w{}_n{}'.format(
...
cPickle.dump(bookcorpus_context_dict, open(save_pkl_path, 'wb'))
