...
parser.add_argument('--qa_split_dir', type=str,
                    ...
                    '/qa_split_genome_memft_thres1_500_thres2_50', help=' ')
...
obj_split_path = os.path.join(config.qa_split_dir, 'object_split.pkl')
object_split = cPickle.load(open(obj_split_path, 'rb'))
...
test_object_set = set(object_split['test'])
