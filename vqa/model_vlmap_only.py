...
class Model(object):
    ...
    def filter_train_vars(self, trainable_vars):
        ...
        for var in trainable_vars:
            if var.name.split('/')[0] == 'V_WordMap': pass
            elif var.name.split('/')[0] == 'v_word_fc': pass
            elif var.name.split('/')[0] == 'q_linear_v': pass
            elif var.name.split('/')[0] == 'v_linear_v': pass
            elif var.name.split('/')[0] == 'hadamard_attention': pass
            elif var.name.split('/')[0] == 'q_linear_l': pass
